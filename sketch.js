...
if(balloon.isTouching(bottomGround) || balloon.isTouching(topGround) || balloon.isTouching(topObstaclesGroup) || balloon.isTouching(bottomObstaclesGroup)) {
  gameState = END;
}
